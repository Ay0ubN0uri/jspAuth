...
//        request.setAttribute("msg", "Your account has been created login now");
        session.setAttribute("status", "success");
        session.setAttribute("message", "Your account has been created login now");
        request.getRequestDispatcher("auth.jsp?email=" + email).forward(request, response);
    }
