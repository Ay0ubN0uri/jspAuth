                    ...
                    <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
                        <form class="space-y-6" action="auth" method="POST">
                            <div>
                                ...
                                <div class="mt-2">
                                    <input id="email" name="email" type="text" required value="${param.email}"
                            ...
                            <div >
                                ...
                                <div class="text-sm flex justify-end">
                                    <a href="forget.jsp" class="font-semibold text-indigo-600 hover:text-indigo-500">Forgot password?</a>
                                </div>
                                <div class="mt-2">
